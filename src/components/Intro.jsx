    ...
    <div id='about' className='flex max-w-3xl flex-col'>
      <div className='flex flex-1 items-center gap-2'>
        ...
        <div className='flex flex-1 flex-col'>
          ...
          <p className='flex-1 text-sm'> Software Development | Product</p>
        </div>
      </div>
      <div className='mt-5'>
        <p>
        ...
        <br />
        <p>
          I believe that the best products are built through the power of well-constructed codebases
          that allow rapid development, and our ability to understand how we, humans, behave.
        </p>
        <br />
